...
public class TopSelling_Popup extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TopSelling_Popup frame = new TopSelling_Popup();
	...
	public TopSelling_Popup() {
	    ...
	    JLabel lblNewLabel_2 = new JLabel("TOP-SELLING");
	    ...
	    lblNewLabel_1.setIcon(new ImageIcon(TopSelling_Popup.class.getResource("/Resources/topicon.png")));
	    ...
	    table.setModel(method.getTopSellingProducts());
